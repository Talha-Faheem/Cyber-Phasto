...
// Eliminates all font-stroke artifacts, overlaps, and weird lines in 'A', 'R', 'B', etc.
...
export default function BottomCta() {
  ...
  return (
    ...
    >
      ...
      {/* ===================================================================
          INTERACTIVE HOVER-GLOW "CYBER PASHTO" WATERMARK
          =================================================================== */}
      <div 
        ref={watermarkRef}
      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d={CYBER_PASHTO_PATH}
              fill="url(#bottomCtaLaserFill)"
              stroke="url(#bottomCtaLaserStroke)"
              strokeWidth="1.5"
              strokeLinejoin="round"
              strokeLinecap="round"
              fillRule="evenodd"
